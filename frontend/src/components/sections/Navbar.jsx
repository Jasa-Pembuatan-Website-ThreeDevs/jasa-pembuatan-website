    ...
    <header className="fixed inset-x-0 top-0 z-50 border-b border-white/[0.08] bg-zinc-950/82 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
        ...
        <details className="group md:hidden">
          <summary
            className="flex h-10 w-10 cursor-pointer list-none items-center justify-center rounded-lg border border-white/10 text-zinc-400 [&::-webkit-details-marker]:hidden"
            aria-label="Toggle menu"
          >
            <Menu className="h-5 w-5" />
          </summary>

          <div className="absolute inset-x-0 top-16 overflow-hidden border-t border-white/[0.08] bg-zinc-950/95 md:hidden">
